...
docker run -v ./tests_run/:/predig -v ./uniprot:/uniprot \
    docker.io/bsceapm/predig predig_input1_uniprot_example.csv --output uniprot_output.csv
...
docker run -v ./tests_run/:/predig -v ./uniprot:/uniprot \
    docker.io/bsceapm/predig predig_input2_recombinant_example.csv --output recombinant_output.csv --type recombinant
...
docker run -v ./tests_run/:/predig -v ./uniprot:/uniprot \
    docker.io/bsceapm/predig predig_input3_b2m_fasta_example.fasta --output fasta_output.csv --type fasta --alleles predig_input3_alleles_example.csv
