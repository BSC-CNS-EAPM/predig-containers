...
LABEL maintainer="Christian Domínguez-Dalmases <christian.dominguez@bsc.es>, Albert Cañellas-Sole <albert.canellas@bsc.es>, Roc Farriol-Duran <roc.farriol@bsc.es>" \
    container="NOAH-PredIG Image" \
    about.summary="NOAH-PredIG" \
...
COPY Immuno/Neoantigens-NOAH /Immuno

# Working directory
WORKDIR /predig

ENTRYPOINT ["micromamba", "run", "-n", "predig_env", "python", "/Immuno/noah/main_NOAH.py"]